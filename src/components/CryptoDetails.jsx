...
const CryptoDetails = () => {
  ...
  const { data2, isFetchingg } = useGetCryptoHistoryQuery(coinId);
  console.log("hiss" + coinHistory);
    ...
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        ...
        <p>
          ...
          statistics,maket cap and supply
        </p>
      </Col>
      <Select
        defaultValue="7d"
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-deading">
      ...
      <Col className="coin-desc-link">
        <Row className="coin-desc">
          ...
          {data?.data?.coin.links.map((lin) => (
            <Row className="coin-link" key={lin.name}>
